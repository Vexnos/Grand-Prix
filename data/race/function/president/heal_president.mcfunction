...
give @s nether_star[custom_data={regen:yes},custom_name={text:"Heal",color:"red",italic:false},consumable={consume_seconds:5,animation:eat},use_cooldown={seconds:10,cooldown_group:heal_president},max_stack_size=2]