...
execute if score #mode gamemode matches 2 at @s as @e[type=skeleton_horse,sort=nearest,limit=1] run tag @s add crownPeak
execute if score #mode gamemode matches 2 run effect give @e[type=skeleton_horse,tag=!crownPeak] speed 40 1 false