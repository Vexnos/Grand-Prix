...
# Surplus Items
execute unless score #oakendale checkpoints matches 1.. run function race:checkpoints/items/oakendale
...
# Catchup
execute unless score #mode gamemode matches 2 run effect give @a[tag=!oakendale] speed 40 1 false
execute if score #mode gamemode matches 2 run effect give @a[tag=!oakendale] luck 20 0 true