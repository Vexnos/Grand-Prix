...
# Catchup
execute unless score #mode gamemode matches 2 run effect give @a[tag=!northwindPass] speed 40 1 false
execute if score #mode gamemode matches 2 run effect give @a[tag=!northwindPass] luck 40 0 true