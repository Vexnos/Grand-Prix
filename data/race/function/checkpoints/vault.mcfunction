...
# Surplus Items
# execute unless score #vault checkpoints matches 1.. run function race:checkpoints/items/vault
...
# Catchup
execute unless score #mode gamemode matches 2 run effect give @a[tag=!vault] speed 40 1 false
execute if score #mode gamemode matches 2 run effect give @a[tag=!vault] luck 20 0 true