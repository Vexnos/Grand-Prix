...
# Surplus Items
execute unless score #felora checkpoints matches 1.. run function race:items/felora
...
execute if score #mode gamemode matches 2 at @s as @e[type=skeleton_horse,sort=nearest,limit=1] run tag @s add felora
execute if score #mode gamemode matches 2 run effect give @e[type=skeleton_horse,tag=!felora] speed 40 1 false