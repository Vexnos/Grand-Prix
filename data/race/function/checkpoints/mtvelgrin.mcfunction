...
# Surplus Items
# execute unless score #mtVelgrin checkpoints matches 1.. run function race:items/mtvelgrin
...
execute if score #mode gamemode matches 2 at @s as @e[type=skeleton_horse,sort=nearest,limit=1] run tag @s add mtVelgrin
execute if score #mode gamemode matches 2 run effect give @e[type=skeleton_horse,tag=!mtVelgrin] speed 40 1 false