...
tellraw @a [{"selector":"@s","color":"dark_green"},{"text":" has reached ","color":"gold"},{"text":"[Sendaria]","color":"green","hoverEvent":{"action":"show_text","contents":{"text":"Reach Sendaria","color":"green"}}}]
