...
# Surplus Items
# execute unless score #sendaria checkpoints matches 1.. run function race:checkpoints/items/sendaria
...
# Catchup
execute unless score #mode gamemode matches 2 run effect give @a[tag=!sendaria] speed 40 1 false
execute if score #mode gamemode matches 2 run effect give @a[tag=!sendaria] luck 20 0 true