...
# Surplus Items
# execute unless score #nestoria checkpoints matches 1.. run function race:checkpoints/items/nestoria
...
# Catchup
execute unless score #mode gamemode matches 2 run effect give @a[tag=!nestoria] speed 40 1 false
execute if score #mode gamemode matches 2 run effect give @a[tag=!nestoria] luck 20 0 true