...
# Surplus Items
execute unless score #nazgard checkpoints matches 1.. run function race:checkpoints/items/nazgard
...
execute if score #mode gamemode matches 2 run effect give @a[tag=!nazgard] luck 20 0 true