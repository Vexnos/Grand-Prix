...
tellraw @a [{"selector":"@s","color":"dark_green"},{"text":" has reached ","color":"gold"},{"text":"[Nazgard]","color":"green","hoverEvent":{"action":"show_text","contents":{"text":"Reach Nazgard","color":"green"}}}]
