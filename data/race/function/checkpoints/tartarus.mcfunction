...
# Surplus Items
execute unless score #tartarus checkpoints matches 1.. run function race:checkpoints/items/tartarus
...
# Catchup
execute unless score #mode gamemode matches 2 run effect give @a[tag=!tartarus] speed 40 1 false
execute if score #mode gamemode matches 2 run effect give @a[tag=!tartarus] luck 20 0 true