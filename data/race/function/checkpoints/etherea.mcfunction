...
# Surplus Items
# execute unless score #etherea checkpoints matches 1.. run function race:checkpoints/items/etherea
...
# Catchup
execute unless score #mode gamemode matches 2 run effect give @a[tag=!etherea] speed 40 1 false
execute if score #mode gamemode matches 2 run effect give @a[tag=!etherea] luck 20 0 true