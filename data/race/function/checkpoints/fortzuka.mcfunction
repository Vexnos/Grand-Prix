...
tellraw @a [{"selector":"@s","color":"dark_green"},{"text":" has reached ","color":"gold"},{"text":"[Fort Zuka]","color":"green","hoverEvent":{"action":"show_text","contents":{"text":"Reach Fort Zuka","color":"green"}}}]
