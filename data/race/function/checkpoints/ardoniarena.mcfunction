...
tellraw @a [{"selector":"@s","color":"dark_green"},{"text":" has reached ","color":"gold"},{"text":"[The Tournament Arena]","color":"green","hoverEvent":{"action":"show_text","contents":{"text":"Reach the Tournament Arena","color":"green"}}}]
