...
# Surplus Items
# execute unless score #ardoniArena checkpoints matches 1.. run function race:checkpoints/items/ardoniarena
...
execute if score #mode gamemode matches 2 run effect give @a[tag=!ardoniArena] luck 20 0 true