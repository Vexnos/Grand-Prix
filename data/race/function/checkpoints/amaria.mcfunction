...
# Surplus Items
# execute unless score #amaria checkpoints matches 1.. run function race:checkpoints/items/amaria
...
# Catchup
execute unless score #mode gamemode matches 2 run effect give @a[tag=!amaria] speed 40 1 false
execute if score #mode gamemode matches 2 run effect give @a[tag=!amaria] luck 20 0 true