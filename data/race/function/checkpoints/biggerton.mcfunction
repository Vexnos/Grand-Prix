...
tellraw @a [{"selector":"@s","color":"dark_green"},{"text":" has reached ","color":"gold"},{"text":"[Biggerton]","color":"green","hoverEvent":{"action":"show_text","contents":{"text":"Reach Biggerton","color":"green"}}}]
