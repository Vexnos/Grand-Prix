kill @e[type=skeleton_horse,team=3]
execute at @s run summon skeleton_horse ~ ~ ~ {Team:"3",Tame:1b,Health:1024.0f,equipment:{saddle:{id:"minecraft:saddle"}},attributes:[{base:0.3377,id:"minecraft:movement_speed"},{base:0.75,id:"minecraft:jump_strength"},{base:1024,id:"minecraft:max_health"}],active_effects:[{id:"minecraft:resistance",amplifier:255,duration:-1,show_particles:false}]}
