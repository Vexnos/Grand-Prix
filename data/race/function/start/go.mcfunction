...
execute if score #mode gamemode matches 4 run give @a[tag=president] crossbow[custom_name={text:"Rocket Launcher",italic:false,color:"red"},enchantments={quick_charge:3,multishot:1,piercing:4},unbreakable={}]
execute if score #mode gamemode matches 4 run give @a[tag=president] firework_rocket[fireworks={explosions:[{colors:[11743532],shape:"large_ball"},{colors:[11743532],shape:"large_ball"},{colors:[11743532],shape:"large_ball"},{colors:[11743532],shape:"large_ball"},{colors:[11743532],shape:"large_ball"},{colors:[11743532],shape:"large_ball"},{colors:[11743532],shape:"large_ball"}],flight_duration:1b}] 16
