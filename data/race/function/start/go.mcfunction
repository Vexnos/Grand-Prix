...
execute if score #mode gamemode matches 4 run give @a[tag=president] nether_star[custom_data={regen:yes},custom_name={text:"Heal",color:"red",italic:false},consumable={consume_seconds:5,animation:toot_horn},use_cooldown={seconds:10,cooldown_group:heal_president},max_stack_size=2]
execute if score #mode gamemode matches 4 run give @a[tag=bodyguard] nether_star[custom_data={strength:yes},custom_name={text:"Strength",color:"light_purple",italic:false},consumable={consume_seconds:0.05,animation:toot_horn},use_cooldown={seconds:120,cooldown_group:strength_bodyguard},max_stack_size=2]
