...
execute if score #players players matches 1..8 run summon skeleton_horse ~ ~ ~ {Team:"1",Tame:1b,equipment:{saddle:{id:"minecraft:saddle"}},attributes:[{base:0.33,id:"minecraft:movement_speed"},{base:0.65,id:"minecraft:jump_strength"}],active_effects:[{id:"minecraft:resistance",amplifier:255,duration:-1,show_particles:false}]}
execute if score #players players matches 2..8 run summon skeleton_horse ~ ~ ~ {Team:"2",Tame:1b,equipment:{saddle:{id:"minecraft:saddle"}},attributes:[{base:0.33,id:"minecraft:movement_speed"},{base:0.65,id:"minecraft:jump_strength"}],active_effects:[{id:"minecraft:resistance",amplifier:255,duration:-1,show_particles:false}]}
execute if score #players players matches 3..8 run summon skeleton_horse ~ ~ ~ {Team:"3",Tame:1b,equipment:{saddle:{id:"minecraft:saddle"}},attributes:[{base:0.33,id:"minecraft:movement_speed"},{base:0.65,id:"minecraft:jump_strength"}],active_effects:[{id:"minecraft:resistance",amplifier:255,duration:-1,show_particles:false}]}
execute if score #players players matches 4..8 run summon skeleton_horse ~ ~ ~ {Team:"4",Tame:1b,equipment:{saddle:{id:"minecraft:saddle"}},attributes:[{base:0.33,id:"minecraft:movement_speed"},{base:0.65,id:"minecraft:jump_strength"}],active_effects:[{id:"minecraft:resistance",amplifier:255,duration:-1,show_particles:false}]}
execute if score #players players matches 5..8 run summon skeleton_horse ~ ~ ~ {Team:"5",Tame:1b,equipment:{saddle:{id:"minecraft:saddle"}},attributes:[{base:0.33,id:"minecraft:movement_speed"},{base:0.65,id:"minecraft:jump_strength"}],active_effects:[{id:"minecraft:resistance",amplifier:255,duration:-1,show_particles:false}]}
execute if score #players players matches 6..8 run summon skeleton_horse ~ ~ ~ {Team:"6",Tame:1b,equipment:{saddle:{id:"minecraft:saddle"}},attributes:[{base:0.33,id:"minecraft:movement_speed"},{base:0.65,id:"minecraft:jump_strength"}],active_effects:[{id:"minecraft:resistance",amplifier:255,duration:-1,show_particles:false}]}
execute if score #players players matches 7..8 run summon skeleton_horse ~ ~ ~ {Team:"7",Tame:1b,equipment:{saddle:{id:"minecraft:saddle"}},attributes:[{base:0.33,id:"minecraft:movement_speed"},{base:0.65,id:"minecraft:jump_strength"}],active_effects:[{id:"minecraft:resistance",amplifier:255,duration:-1,show_particles:false}]}
execute if score #players players matches 8 run summon skeleton_horse ~ ~ ~ {Team:"8",Tame:1b,equipment:{saddle:{id:"minecraft:saddle"}},attributes:[{base:0.33,id:"minecraft:movement_speed"},{base:0.65,id:"minecraft:jump_strength"}],active_effects:[{id:"minecraft:resistance",amplifier:255,duration:-1,show_particles:false}]}
